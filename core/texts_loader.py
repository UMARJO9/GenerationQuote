...
DEFAULT_TEXTS = {
    ...
    "add": {
        ...
        "prompts": {
            "open_settings": {
                "title": "Настройки",
                "open_settings_author": "Автор не выбран или отсутствует в списке. Открыть настройки, чтобы добавить?",
                "open_settings_category": "Категория не выбрана или отсутствует в списке. Открыть настройки, чтобы добавить?"
            }
        }
    },
    "settings": {
